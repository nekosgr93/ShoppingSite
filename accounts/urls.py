...
urlpatterns = [
    ...
    url(r'^profiles/(?P<username>[-\w]+)/$', views.UserProfile.as_view(), name='profiles'),
    url(r'^profiles/(?P<username>[-\w]+)/edit/$', views.UpdateProfile.as_view(), name='profile_edit'),
    url(r'^address/(?P<username>[-\w]+)/$', views.AddressList.as_view(), name='user_address'),
    url(r'^address/(?P<username>[-\w]+)/new/$', views.CreateAddress.as_view(), name='create_address'),
